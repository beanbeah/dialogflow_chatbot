...
public class RequestTask extends AsyncTask<Void, Void, DetectIntentResponse> {
    ...
    //Constructor, initialise objects.
    ...
    protected DetectIntentResponse doInBackground(Void... voids) {
        //that was some gay android async shit.
        //https://stackoverflow.com/questions/23082358/void-params-meaning-in-java-function-declaration
        try{
